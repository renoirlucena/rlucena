            ...
            <div className="section blog">
                <div className="content">
                    ...
                    <div className="blog-items">
                            ...
                            <div className="blog-item content-box">
                                <div className="post">
                                    ...
                                    <div className="desc">
                                        ...
                                        <Link href="/blog_post">
                                            <a className="name">Welcome to React!</a>
                                        </Link>
                                        <div className="single-post-text">
                                            <p>So striking at of to welcomed resolved. Northward by described up household therefore attention. Excellence decisively nay man yet impression for contrasted remarkably.</p>
                                        </div>
                        ...
                        {/* ... Continue in the same way for other blog items ... */}
                        ...
                        <div className="content-sidebar">
                            <aside id="secondary" className="widget-area">
                                ...
                                <section className="widget widget_recent_entries">
                                    ...
                                    <ul>
                                        <li><a href="#">Welcome to Jekyll!</a></li>
                                        <li><a href="#">By spite about do of do allow blush</a></li>
                                        <li><a href="#">Two Before Arrow Not Relied</a></li>
                                        <li><a href="#">Design in Mobile Application</a></li>
                                    </ul>
                                </section>
