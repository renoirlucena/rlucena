                  ...
                  <div className="blog-item content-box">
                      <div className="post">
                          ...
                          <div className="desc">
                              ...
                              <Link href="/blog_post" className="name">Two Before Arrow Not Relied</Link>
                  ...
                  <div className="blog-item content-box">
                      <div className="post">
                          ...
                          <div className="desc">
                              ...
                              <Link href="/blog_post" className="name">Welcome to React!</Link>
                              <div className="single-post-text">
                                  <p>So striking at of to welcomed resolved. Northward by described up household therefore attention. Excellence decisively nay man yet impression for contrasted remarkably.</p>
                  ...
                  <div className="blog-item content-box">
                      <div className="post">
                          ...
                          <div className="desc">
                              ...
                              <Link href="/blog_post" className="name">By spite about do of do allow blush</Link>
                              <div className="single-post-text">
                                  <p>So striking at of to welcomed resolved. Northward by described up household therefore attention. Excellence decisively nay man yet impression for contrasted remarkably.</p>
                  ...
                  <div className="blog-item content-box">
                      <div className="post">
                          ...
                          <div className="desc">
                              ...
                              <Link href="/blog_post" className="name">Design in Mobile Application</Link>
                              <div className="single-post-text">
                                  <p>So striking at of to welcomed resolved. Northward by described up household therefore attention. Excellence decisively nay man yet impression for contrasted remarkably.</p>
                  ...
                  <div className="blog-item content-box">
                      <div className="post">
                          ...
                          <div className="desc">
                              ...
                              <Link href="/blog_post" className="name">By spite about what to do</Link>
                              <div className="single-post-text">
                                  <p>So striking at of to welcomed resolved. Northward by described up household therefore attention. Excellence decisively nay man yet impression for contrasted remarkably.</p>
